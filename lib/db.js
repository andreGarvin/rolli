...
exports.get_groups_db = function( user_name, callback ) {
...
exports.search_db = function( query_obj, callback ) {
    ...
    db.get('db_obj', (err, db_obj) => {
        ...
        if ( query_obj.action === 'user' ) {
            ...
            return callback(null, {
                type: 'user-search',
                data: `user search for ${ query_obj.db_name }`
            });
        ...
        return callback({
            type: 'search',
            msg: `search resulted to null; query was not successful.`
        }, undefined);
